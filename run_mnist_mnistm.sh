...
CUDA_VISIBLE_DEVICES=0 python3 vada_train.py --r 0.7 0.3 --src mnist --tgt mnistm --orth --seed 12

CUDA_VISIBLE_DEVICES=0 python3 vada_train.py --r 0.7 0.3 --src mnist --tgt mnistm --seed 12
