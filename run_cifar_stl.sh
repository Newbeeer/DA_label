CUDA_VISIBLE_DEVICES=0 python3 vada_train.py --r 0.7 0.3 --src cifar --tgt stl  --seed 1 --dw 1e-1 --orth

CUDA_VISIBLE_DEVICES=0 python3 vada_train.py --r 0.7 0.3 --src cifar --tgt stl  --seed 1 --dw 1e-1
